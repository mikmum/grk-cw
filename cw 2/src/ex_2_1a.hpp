...
void renderScene(GLFWwindow* window)
{
	...
	transformation = glm::eulerAngleXYZ( 0.5, sin(glfwGetTime()), 0.5);
...
void init(GLFWwindow* window)
{
	...
	glVertexAttribPointer(glGetAttribLocation(program, "vertexColor"), 4, GL_FLOAT, GL_FALSE, 8 * sizeof(float), (void*)(4 * sizeof(float)));
