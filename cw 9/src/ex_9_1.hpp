...
void init(GLFWwindow* window)
{
	...
	metallic::table = Core::LoadTexture("./textures/tableMetallic.jpg");
	metallic::room = Core::LoadTexture("./textures/roomMetallic.jpg");
	metallic::plane = Core::LoadTexture("./textures/planeMetallic.jpg");
	metallic::wardrobe = Core::LoadTexture("./textures/wardrobeMetallic.png");
	metallic::bed = Core::LoadTexture("./textures/bedMetallic.png");
	metallic::sheet = Core::LoadTexture("./textures/sheetMetallic.png");
	metallic::pillow = Core::LoadTexture("./textures/pillowMetallic.png");
	metallic::chair = Core::LoadTexture("./textures/chairMetallic.png");
	metallic::desk = Core::LoadTexture("./textures/deskMetallic.png");
	metallic::clay = Core::LoadTexture("./textures/clayMetallic.jpg");
	metallic::marble = Core::LoadTexture("./textures/marbleMetallic.png");
	metallic::window = Core::LoadTexture("./textures/windowMetallic.png");

	roughness::ball = Core::LoadTexture("./textures/ballRoughness.png");
	...
	roughness::wardrobe = Core::LoadTexture("./textures/wardrobeRoughness.png");
	roughness::bed = Core::LoadTexture("./textures/bedRoughness.png");
	roughness::sheet = Core::LoadTexture("./textures/sheetRoughness.png");
	roughness::pillow = Core::LoadTexture("./textures/pillowRoughness.png");
	roughness::chair = Core::LoadTexture("./textures/chairRoughness.png");
	roughness::desk = Core::LoadTexture("./textures/deskRoughness.png");
	roughness::clay = Core::LoadTexture("./textures/clayRoughness.jpg");
	roughness::marble = Core::LoadTexture("./textures/marbleRoughness.png");
	roughness::window = Core::LoadTexture("./textures/windowRoughness.png");

	ao::ball = Core::LoadTexture("./textures/ballAo.png");
	...
	ao::wardrobe = Core::LoadTexture("./textures/wardrobeAo.png");
	ao::bed = Core::LoadTexture("./textures/bedAo.png");
	ao::sheet = Core::LoadTexture("./textures/sheetAo.png");
	ao::pillow = Core::LoadTexture("./textures/pillowAo.png");
	ao::chair = Core::LoadTexture("./textures/chairAo.png");
	ao::desk = Core::LoadTexture("./textures/deskAo.png");
	ao::clay = Core::LoadTexture("./textures/clayAo.jpg");
	ao::marble = Core::LoadTexture("./textures/marbleAo.png");
	ao::window = Core::LoadTexture("./textures/windowAo.png");
